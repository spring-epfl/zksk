...
def test_multi_and_BLAC_binding1():
    ...
    pr3 = DLRepNotEqualProof([lhs_tab[2], tab_g[2]], [lhs_tab[1], tab_g[1]], [secrets_aliases[2]], binding=True)
    pr4 = DLRepNotEqualProof([lhs_tab[1], tab_g[1]], [lhs_tab[3], tab_g[3]], [secrets_aliases[0]], binding=True)
...
def test_multi_and_BLAC_binding2():
    ...
    pr11 = DLRepNotEqualProof([lhs_tab[0], tab_g[0]], [lhs_tab[1], tab_g[1]], [secrets_aliases[0]], binding=False)
